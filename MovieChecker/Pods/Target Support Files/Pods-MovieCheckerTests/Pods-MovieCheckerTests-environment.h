...
// ILGAsserts
#define COCOAPODS_POD_AVAILABLE_ILGAsserts
#define COCOAPODS_VERSION_MAJOR_ILGAsserts 1
#define COCOAPODS_VERSION_MINOR_ILGAsserts 1
#define COCOAPODS_VERSION_PATCH_ILGAsserts 1
